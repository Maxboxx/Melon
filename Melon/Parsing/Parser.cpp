...
void Parser::SetupTokens() {
	...
	patterns.Add(TokenPattern(TokenType::AlsoIf, "alif"));
	patterns.Add(TokenPattern(TokenType::ElseIf, "elif"));
	patterns.Add(TokenPattern(TokenType::While, "while"));
	patterns.Add(TokenPattern(TokenType::AlsoWhile, "alwhile"));
	patterns.Add(TokenPattern(TokenType::ElseWhile, "elwhile"));
	patterns.Add(TokenPattern(TokenType::For, "for"));
	patterns.Add(TokenPattern(TokenType::AlsoFor, "alfor"));
	patterns.Add(TokenPattern(TokenType::ElseFor, "elfor"));
